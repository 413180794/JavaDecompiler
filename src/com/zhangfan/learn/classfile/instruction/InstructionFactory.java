...
//    public static Instruction getInstruction(FileInputStream fileInputStream) {
//        // 根据opcode（一个字节） 来判断是什么指令
//        Count opcode = new Count(fileInputStream, UKind.U1);
//        switch (opcode.getNum()) {
//            case NOP:
//                return null;
//            case ACONST_NULL:
